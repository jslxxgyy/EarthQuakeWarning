...
public class SettingsPageViewModel
{
    ...
    public ISetting<LocationSetting>? LocationSetting { get; set; }
    ...
    public SettingsPageViewModel(ISetting<CurrentPosition> currentPosition, ISetting<AlertLimit> alertLimit,
        ISetting<UpdaterSetting>? updateSetting, ISetting<TrackerSetting>? trackerSetting, ISetting<TimeSetting>? timeSetting, ISetting<LocationSetting> locationSetting, IServiceProvider provider)
    {
